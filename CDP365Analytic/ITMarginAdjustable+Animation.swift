//
//  ITMarginAdjustable+Animation.swift
//  SwiftMessages
//
...
extension ITMarginAdjustable where Self: UIView {
    public func defaultMarginAdjustment(context: ITAnimationContext) -> UIEdgeInsets {
