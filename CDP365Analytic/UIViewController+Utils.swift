...
extension UIViewController {
    ...
    func sm_selectPresentationContextTopDown(_ config: ITSwiftMessages.ITConfig) -> UIViewController {
        ...
        return ITWindowViewController.newInstance(windowLevel: self.view.window?.windowLevel, config: config)
    }
    ...
    func sm_selectPresentationContextBottomUp(_ config: ITSwiftMessages.ITConfig) -> UIViewController {
        let topBottomStyle = config.presentationStyle.topBottomStyle
...
extension ITSwiftMessages.ITPresentationStyle {
    ...
    var topBottomStyle: ITTopBottomAnimation.ITStyle? {
        switch self {
        case .top: return .top
        case .bottom: return .bottom
        case .custom(let animator): return (animator as? ITTopBottomAnimation)?.style
