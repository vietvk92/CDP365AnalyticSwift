...
public protocol ITKeyboardTrackingViewDelegate: class {
    func keyboardTrackingViewWillChange(change: ITKeyboardTrackingView.Change, userInfo: [AnyHashable : Any])
    func keyboardTrackingViewDidChange(change: ITKeyboardTrackingView.Change, userInfo: [AnyHashable : Any])
}
...
open class ITKeyboardTrackingView: UIView {
    ...
    public weak var delegate: ITKeyboardTrackingViewDelegate?
