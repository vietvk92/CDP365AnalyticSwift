...
open class ANKeychainSwift {
  ...
  */
  ...
  open func set(_ value: Data, forKey key: String) -> Bool {
    ...
    let accessible = ANKeychainSwiftConstants.toString(kSecAttrAccessibleWhenUnlocked)
      
    let prefixedKey = keyWithPrefix(key)
      
    var query: [String : Any] = [
      ANKeychainSwiftConstants.klass       : kSecClassGenericPassword,
      ANKeychainSwiftConstants.attrAccount : prefixedKey,
      ANKeychainSwiftConstants.valueData   : value,
      ANKeychainSwiftConstants.accessible  : accessible
    ]
  ...
  */
  open func getData(_ key: String, asReference: Bool = false) -> Data? {
    ...
    var query: [String: Any] = [
      ANKeychainSwiftConstants.klass       : kSecClassGenericPassword,
      ANKeychainSwiftConstants.attrAccount : prefixedKey,
      ANKeychainSwiftConstants.matchLimit  : kSecMatchLimitOne
    ]
    
    if asReference {
      query[ANKeychainSwiftConstants.returnReference] = kCFBooleanTrue
    } else {
      query[ANKeychainSwiftConstants.returnData] =  kCFBooleanTrue
    }
  ...
  */
  public var allKeys: [String] {
    var query: [String: Any] = [
      ANKeychainSwiftConstants.klass : kSecClassGenericPassword,
      ANKeychainSwiftConstants.returnData : true,
      ANKeychainSwiftConstants.returnAttributes: true,
      ANKeychainSwiftConstants.returnReference: true,
      ANKeychainSwiftConstants.matchLimit: ANKeychainSwiftConstants.secMatchLimitAll
    ]
    ...
    if lastResultCode == noErr {
      return (result as? [[String: Any]])?.compactMap {
        $0[ANKeychainSwiftConstants.attrAccount] as? String } ?? []
    }
  ...
  */
  ...
  func addAccessGroupWhenPresent(_ items: [String: Any]) -> [String: Any] {
    ...
    result[ANKeychainSwiftConstants.accessGroup] = accessGroup
    return result
  }
  ...
  */
  func addSynchronizableIfRequired(_ items: [String: Any], addingItems: Bool) -> [String: Any] {
    ...
    var result: [String: Any] = items
    result[ANKeychainSwiftConstants.attrSynchronizable] = addingItems == true ? true : kSecAttrSynchronizableAny
    return result
  }
}
...
public struct ANKeychainSwiftConstants {
