...
class ANLocation: NSObject,CLLocationManagerDelegate {
    
    enum ANLocationErrors: String {
    ...
    //Singleton Instance
    static let sharedInstance: ANLocation = {
        let instance = ANLocation()
        // setup code
        return instance
    }()
    ...
    @objc private func sendPlacemark() {
        guard let _ = lastLocation else {
            ...
            self.didCompleteGeocoding(location: nil, placemark: nil, error: NSError(
                ...
                userInfo:
                [NSLocalizedDescriptionKey:ANLocationErrors.notFetched.rawValue,
                 NSLocalizedFailureReasonErrorKey:ANLocationErrors.notFetched.rawValue,
                 NSLocalizedRecoverySuggestionErrorKey:ANLocationErrors.notFetched.rawValue]))
        ...
        CLGeocoder().reverseGeocodeLocation(location!, completionHandler: {(placemarks, error)->Void in
            ...
            if (error != nil) {
                ...
                self.didCompleteGeocoding(location: nil, placemark: nil, error: NSError(
                    ...
                    code:Int(CLAuthorizationStatus.denied.rawValue),
                    userInfo:
                    [NSLocalizedDescriptionKey:ANLocationErrors.reverseGeocodingFailed.rawValue,
                     NSLocalizedFailureReasonErrorKey:ANLocationErrors.reverseGeocodingFailed.rawValue,
                     NSLocalizedRecoverySuggestionErrorKey:ANLocationErrors.reverseGeocodingFailed.rawValue]))
                return
            }
            if placemarks!.count > 0 {
                ...
                if let _ = location {
                    ...
                    self.didCompleteGeocoding(location: nil, placemark: nil, error: NSError(
                        ...
                        code:Int(CLAuthorizationStatus.denied.rawValue),
                        userInfo:
                        [NSLocalizedDescriptionKey:ANLocationErrors.invalidLocation.rawValue,
                         NSLocalizedFailureReasonErrorKey:ANLocationErrors.invalidLocation.rawValue,
                         NSLocalizedRecoverySuggestionErrorKey:ANLocationErrors.invalidLocation.rawValue]))
                }
    ...
    func locationManager(_ manager: CLLocationManager, didChangeAuthorization status: CLAuthorizationStatus) {
        ...
        case .denied:
            let deniedError = NSError(
                ...
                code:Int(CLAuthorizationStatus.denied.rawValue),
                userInfo:
                [NSLocalizedDescriptionKey:ANLocationErrors.denied.rawValue,
                 NSLocalizedFailureReasonErrorKey:ANLocationErrors.denied.rawValue,
                 NSLocalizedRecoverySuggestionErrorKey:ANLocationErrors.denied.rawValue])
